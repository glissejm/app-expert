      ...
      <div className="flex flex-col text-white items-center my-6 mx-24 py-6 px-6 bg-third rounded-2xl">
        ...
        <div>
          <div className="form-check">
            ...
            <label className="form-check-label inline-block" htmlFor="scf1">
              Geometría
            </label>
          </div>
          <div className="form-check">
            ...
            <label className="form-check-label inline-block" htmlFor="scf2">
              Álgebra
            </label>
          </div>
          <div className="form-check">
            ...
            <label className="form-check-label inline-block" htmlFor="scf3">
              Trigonometría
            </label>
          </div>
          <div className="form-check">
            ...
            <label className="form-check-label inline-block" htmlFor="scf4">
              Aritmética
            </label>
          </div>
          <div className="form-check">
            ...
            <label className="form-check-label inline-block" htmlFor="scf5">
              R. Matemático
            </label>
          </div>
          <div className="form-check">
            ...
            <label className="form-check-label inline-block" htmlFor="scf6">
              Química
            </label>
          </div>
          <div className="form-check">
            ...
            <label className="form-check-label inline-block" htmlFor="scf7">
              Física
            </label>
          </div>
        </div>
