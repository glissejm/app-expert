...
export default function QuestionBox({name, course, topic, difficult,id}) {
  return (
      <Link className="group question rounded-full flex items-center place-content-around bg-third border-white hover:bg-white text-white border py-2 mb-2" to={{pathname: `${id}`}}>
